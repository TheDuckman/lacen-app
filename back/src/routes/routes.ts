...
router.get("/downloadBootstrapCsv", Controller.downloadBootstrapCsv);
...
router.get("/getLncRnaFolders", Controller.getLncRnaFolders);
router.get("/downloadLncRnaFile", Controller.downloadLncRnaFile);
